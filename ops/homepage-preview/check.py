...
def main():
    ...
    with sync_playwright() as p:
        ...
        check('Example opens public source in a separate tab', popup.url == 'https://expert-atlas--gbautoxyz.netlify.app/style-guide/library/axisform-studio-landing.html')
        popup.close()
