...
- GCS upload completed through keyless service-account impersonation.
- Uploader service account: `gbauto-artifact-uploader@gbautomationxyz.iam.gserviceaccount.com`.
- Impersonation initially lagged, then propagated and verified with `IMP_UPLOAD_OK`.
...
- Creation Time: `2026-06-28T23:57:04Z`
- Content-Length: `3697`
- Storage Class: `STANDARD`
- Generation: `1782691024853676`
- Uploaded as: `gbauto-artifact-uploader@gbautomationxyz.iam.gserviceaccount.com` via impersonation
