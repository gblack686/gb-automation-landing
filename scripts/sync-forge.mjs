...
const expected=['forge/index.html','forge/app.js','forge/style.css','forge/theme.js','forge/particle-scene.js','forge/gb-signature.png','forge/gb-particle-poster.jpg','forge/config.js'];
...
console.log('Verified and copied eight public Forge assets.');
