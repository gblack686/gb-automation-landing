...
const expected=['forge/index.html','forge/app.js','forge/style.css','forge/theme.js','forge/particle-scene.js','forge/gb-signature.png','forge/gb-particle-poster.jpg','forge/animated-cta.css','forge/config.js'];
...
console.log('Verified and copied nine public Forge assets.');
