/**
 * jid5274 (Jason Diaz / Practice Management Consultants) tenant dataset registry.
 *
...
export const JID5274_DATASETS = [
  ...
  {
    view: 'obs_jid5274_scrape_receipts',
  ...
  {
    view: 'obs_jid5274_scrape_health',
    label: 'Scrape Health',
  ...
  {
    view: 'obs_jid5274_skill_metrics_daily',
    label: 'Skill Metrics',
  ...
  {
    view: 'obs_jid5274_trace_cost_daily',
    label: 'Trace Cost',
  ...
  {
    view: 'obs_jid5274_dispatch_links',
...
export function datasetsByGroup(group) {
  return JID5274_DATASETS.filter((d) => d.group === group);
}

/** Lookup a registry entry by view name (null if not allow-listed). */
export function findDataset(view) {
  return JID5274_DATASETS.find((d) => d.view === view) || null;
}
