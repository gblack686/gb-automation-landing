    ...
    <header className="border-b border-[#D6D4C8]/70 bg-[#F3F1E7]/95 backdrop-blur">
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-5 md:flex-row md:items-center md:justify-between">
        <Link
          ...
          aria-label="GB Automation Client Hub home"
        >
          <span className="flex h-9 w-9 items-center justify-center rounded-md border border-[#D6D4C8] bg-[#F3F1E7] p-1">
            <img src="/gb-logo.png" alt="GB logo" className="h-full w-full object-contain" />
          </span>
          <span>
