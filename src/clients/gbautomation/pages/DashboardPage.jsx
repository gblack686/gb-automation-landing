    ...
    <div className="space-y-10">
      ...
      <section className="grid gap-6 lg:grid-cols-[0.95fr_1.05fr]">
        <div>
          <div className="mb-4 flex items-center gap-2">
            ...
            <h2 className="font-serif text-2xl text-[#191919]">Portal Activity</h2>
          </div>
        ...
        <div>
          <div className="mb-4 flex items-center gap-2">
            ...
            <h2 className="font-serif text-2xl text-[#191919]">Next Steps</h2>
          </div>
      ...
      <section className="rounded-md border border-[#D6D4C8] bg-[#191919] p-5 text-[#F3F1E7]">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          ...
          <span
            className="inline-flex min-h-0 items-center gap-2 rounded-md border border-emerald-200 bg-emerald-50 px-3 py-2 text-xs font-semibold uppercase tracking-widest text-emerald-700"
          >
