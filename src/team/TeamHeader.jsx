...
const navItems = [
  ...
  { label: 'PRDs', to: '/team/prds' },
  { label: 'Builds', to: '/team/builds' },
  { label: 'Runs', to: '/team/runs' },
  { label: 'Artifacts', to: '/team/artifacts' },
  { label: 'Receipts', to: '/team/receipts' },
];
      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-4 px-6 py-5 lg:flex-row lg:items-center lg:justify-between">
        <Link to="/" className="flex min-h-0 items-center gap-3" aria-label="GB Automation home">
          <span className="flex h-9 w-9 items-center justify-center rounded-md border border-[#D6D4C8] bg-[#191919]">
            <ClipboardCheck className="h-4 w-4 text-[#F3F1E7]" />
          </span>
          <span>
            <span className="block text-xs font-semibold uppercase text-[#191919]/50">
              Team Cockpit
            </span>
            <span className="block font-serif text-xl text-[#191919]">Build Read Model</span>
          </span>
        </Link>
