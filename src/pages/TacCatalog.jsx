  ...
  return (
    <div className="min-h-screen bg-[#F3F1E7] text-[#191919] selection:bg-[#D97757] selection:text-white">
      <header className="border-b border-[#D6D4C8]/70 bg-[#F3F1E7]">
        <div className="mx-auto flex max-w-7xl items-center justify-between gap-4 px-5 py-4">
          ...
          <nav className="flex items-center gap-4 text-xs font-bold uppercase tracking-widest">
            ...
            <a href="/tac/style.json" className="text-[#191919]/60 hover:text-[#D97757]">Style API</a>
            <a href="/tac/catalog.json" className="text-[#191919]/60 hover:text-[#D97757]">Catalog JSON</a>
          </nav>
        </div>
      </header>
      ...
      <main className="mx-auto max-w-7xl px-5 py-8">
        ...
        <section className="mb-6 rounded-lg border border-[#D6D4C8] bg-[#E6E4D9]/60 p-5 hover-shiny">
          <div className="grid gap-5 lg:grid-cols-[1.2fr,0.8fr] lg:items-center">
            <div>
              <div className="mb-2 text-[11px] font-bold uppercase tracking-widest text-[#D97757]">Public Agent Style Surface</div>
              <h2 className="font-serif text-3xl font-medium text-[#191919]">Give other agents the GBauto look without private TAC access.</h2>
              <p className="mt-3 max-w-3xl text-sm leading-6 text-[#5C5C5C]">
                Public, read-only endpoints expose the GBauto theme contract: Newsreader, Inter, cream/glass panels, terracotta accents, and the live hover primitives TAC Lead now requires for frontend work.
              </p>
            </div>
            <div className="grid gap-2 text-sm">
              <a className="hover-mini rounded-md border border-[#D6D4C8] bg-white px-3 py-2 font-semibold text-[#191919] hover:bg-[#191919] hover:text-[#F3F1E7]" href="/tac/style.json">/tac/style.json</a>
              <a className="hover-mini rounded-md border border-[#D6D4C8] bg-white px-3 py-2 font-semibold text-[#191919] hover:bg-[#191919] hover:text-[#F3F1E7]" href="/tac/style.md">/tac/style.md</a>
              <a className="hover-mini rounded-md border border-[#D6D4C8] bg-white px-3 py-2 font-semibold text-[#191919] hover:bg-[#191919] hover:text-[#F3F1E7]" href="/tac/agent-style.md">/tac/agent-style.md</a>
              <a className="hover-mini rounded-md border border-[#D6D4C8] bg-white px-3 py-2 font-semibold text-[#191919] hover:bg-[#191919] hover:text-[#F3F1E7]" href="/llms.txt">/llms.txt</a>
            </div>
          </div>
        </section>
